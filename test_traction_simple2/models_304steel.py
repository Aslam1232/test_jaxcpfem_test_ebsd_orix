...
class CrystalPlasticity(Problem):
    ...
    def get_maps(self):
        ## Hu: initial hardening, unit: MPa
        h = 392.9772
        ## Hu: saturation strength, unit: MPa
        t_sat = 7295.1754
        ## Hu: 'a' in Kalidini model
        gss_a = 8.0
        ...
        def get_partial_tensor_map(Fp_inv_old, slip_resistance_old, slip_old, rot_mat):
            ...
            def newton_solver(x):
                ...
                def cond_fun(state):
                    ...
                    ## Hu: In MOOSE: while (rnorm > _rtol * rnorm0 && rnorm > _abs_tol && iteration < _maxiter)
